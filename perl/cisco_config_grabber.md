...
# It currently backs up the running configuration, all extensions imported 
# via "import webvpn" command, the CSD configuration XML file, and the DAP 
...
#       -r: Restore with an argument that specifies the file name. This 
#           file is produced during backup. 
...
## References:
- [Managing Software and Configurations: For ASA 8.3 and above. Cisco Press](http://www.cisco.com/en/US/docs/security/asa/asa83/configuration/guide/admin_swconfig.html)